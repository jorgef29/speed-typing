...
let palabras = [];
let palabraIndice = 0;
// la hora de inicio; date.now retorna la fecha local
...
//cada vez que se hace click se activara la sgte funcion anonima
document.getElementById('inicio').addEventListener('click', () => {
  ...
  typedValueElement.addEventListener('input', () => {
    ...
    //igualdad entre string se utiliza === 
    if (typedValue === currentWord && palabraIndice === palabras.length - 1) {
      ...
      //.endswhit retorna si se termino con ese caracter; .trim elimina los espacios 
      ...
      for (const palabraElemento of textoElement.childNodes) {
